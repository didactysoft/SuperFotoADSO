      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="agregar_trabajo.php"> <img width="22" height="22" src="img\Iconos/agregar_trabajo.svg" class="mx-2"></i>Agregar Trabajo</a></li>
  ...
  <section>
    <div class="container">
      ...
      <div class="card container">
        ...
        <br>
        <div>
          <form id="form_agregar_trabajo" class="text-right" action="procesos/agregar_trabajo.php" method="post">
            ...
            <div class="row container">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control form-control-sm" name="inputTitulo" id="inputTitulo" placeholder="Título" required="">
              </div>
            </div>
            <div class="row container">
              <label class="col-sm-2 col-form-label">Ruta: </label>
              <div class="col-sm-10">
                <input type="text" class="form-control form-control-sm" name="inputRuta" id="inputRuta" placeholder="Ruta" required="">
              </div>
            </div>
            <div class="row container">
            ...
            <div class="row container" id="div_productos_carrito" hidden="">
              ...
              <div class="col-sm-10" id="tabla_productos_carrito">
              </div>
            </div>
            ...
            <div class="row container">
              ...
              <div class="col-sm-4">
                <input type="date" class="form-control form-control-sm" name="inputFecha" id="inputFecha" required="">
              </div>
              <label class="col-sm-2 col-form-label">Hora de entrega</label>
              <div class="col-sm-4">
                <input type="time" class="form-control form-control-sm" name="inputHora" id="inputHora" required="">
              </div>
            </div>
            ...
            <div class="row container">
              ...
              <label class="col-auto col-form-label">Abono: </label>
              <div class="col-auto">
                <input type="number" class="form-control form-control-sm" name="inputAbono" id="inputAbono" placeholder="Abono" required="">
              </div>
              <div class="col-sm-1">
                <button type="button" class="btn btn-sm btn-primary" onclick="calcular_saldo()">Calcular</button>
              </div>
              <label class="col-auto col-form-label">Saldo: </label>
              <div class="col-auto">
                <input type="text" class="form-control form-control-sm" name="inputSaldo" id="inputSaldo" placeholder="Saldo" required="" disabled="">
              </div>
            </div>
            <div class="row text-center justify-content-center">
              <div>
                <button type="button" class="btn btn-sm btn-primary" onclick="generar_orden()">Generar Orden</button>
              </div>
              <br>
            </div>
            <br>
...
<script type="text/javascript">
  ...
  {
    datos=$('#form_agregar_trabajo').serialize();
    $.ajax({
      type:"POST",
      data:datos,
  ...
  function agregar_producto_desde_tabla(cod_producto)
  {
    ...
    $.ajax({
      ...
      url:"procesos/buscar_producto.php",
  ...
  function calcular_saldo()
  {
    ...
    $.ajax({
      ...
      success:function(r)
      {
        ...
        {
          alertify.error("Valor o Abono INCORRECTOS");
          $("#inputSaldo" ).val('');
        }
      }
    });
            ...
            success:function(r)
            {
              ...
              if (saldo >= 0)
              {
                ...
                $.ajax({
                  type:"POST",
                  data:datos,
                  url:"procesos/agregar_trabajo.php",
                  ...
                  success:function(r)
                  {
                    ...
                    {
                      r=r-0;
                      alertify.success("ORDEN GENERADA CON EXITO");
                      $.ajax({
                        type:"POST",
                        data:"cod_trabajo="+r,
                        url:"ticket.php",
